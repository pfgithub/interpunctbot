module.exports = {
	...
	rules: {
		...
		"semi-spacing": [0, { before: false, after: true }], // disallow space before semicolon
		...
		"generator-star-spacing": [0, { before: true, after: false }], // enforce the position of the * in generator functions (off by default)
