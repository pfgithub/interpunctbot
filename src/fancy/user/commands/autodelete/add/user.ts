...
import { Message, renderEphemeral, renderError, SlashCommand, SlashCommandArgDuration, SlashCommandArgUser, SlashCommandElement, u } from "../../../../fancylib";

export default function Command(): SlashCommandElement {
    return SlashCommand({
        label: u("user"),
        description: u("Automatically remove messages from a certain user after a certain time period"),
        args: {
            user: SlashCommandArgUser({
